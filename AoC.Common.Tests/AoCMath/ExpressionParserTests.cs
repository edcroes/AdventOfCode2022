...
public class ExpressionParserTests
{
    ...
    {
        var func = ExpressionParser.ParseSimpleMathExpression<int>("i => i + 10");
    ...
    {
        var func = ExpressionParser.ParseSimpleMathExpression<int>("i => 10 + i");
        Assert.AreEqual(15, func(5));
    }
    ...
    {
        var func = ExpressionParser.ParseSimpleMathExpression<int>("i => i + i");
